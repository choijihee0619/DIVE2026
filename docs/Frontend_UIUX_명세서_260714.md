...
| ADV-00~03 | 상담 큐[확정 필요], 모델1 추론, `POST /rag/search`, `POST /verifications/{id}/decision`[확정 필요], `POST /referrals`[확정 필요] | `is_mock` + mock 상담 큐 |
...
| `['counselQueue', filters]` | 상담 큐 목록 | ADV-00 |
