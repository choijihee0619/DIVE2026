...
export const GLOSSARY = {
  ...
  repaymentCapability: {
    term: "상환능력 증빙",
    short: "임대인이 만기에 보증금을 돌려줄 수 있는지 서류로 확인하는 것 — 소득·재직, 반환 이력, 여신 한도, 자산.",
    long: "계약 만기 90일 전(D-90)부터 기본 서류 제출을 요구하고, 미제출 시 D-90/60/30 단계별로 임차인·임대인·HUG에 알림이 발송됩니다. 제출 파일은 해시로 무결성이 보장됩니다.",
    audience: ["common"],
  },
  ...
  lawsuitAdvance: {
    term: "소송대지급금",
    short: "소송 등 법적 절차에서 HUG가 먼저 지출하고 채무자에게 회수하는 비용성 부대채권.",
    long: "보증금 자체를 대신 지급하는 구상채권과 달리, 절차 수행에 든 비용을 회수하는 채권이라 금액 규모와 회수 양상이 다릅니다.",
    audience: ["hug"],
  },
  claimIndemnity: {
    term: "구상채권",
